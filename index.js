...
const findFourthAgain = numberArr => numberArr[3] 
...
// ANSWER:
const getNumbersSquaredAgain = numbers => numbers.map((num) => num * num)
O(1)
...
// ANSWER: Each function relies on a string that could have up to infinite length. 
